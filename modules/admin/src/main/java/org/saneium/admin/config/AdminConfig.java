package org.saneium.admin.config;
...
@WebListener
@Configuration
public class AdminConfig implements WebApplicationInitializer, EmbeddedServletContainerCustomizer{

    @Autowired
    private ApplicationContext applicationContext;

    @Bean(name = "adminConfigServlet")
